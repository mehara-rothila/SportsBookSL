...
const facilities = [
  {
    ...
    image: '/images/featuredFacilities/sugathadasa-stadium.jpg',
    price: 'Rs. 5,000/hr',
    isNew: false,
    premium: true,
  },
  {
    ...
    reviews: 98,
    sportTypes: ['Cricket'],
    image: '/images/featuredFacilities/premadasa-stadium.jpg',
    price: 'Rs. 8,000/hr',
    isNew: false,
    premium: true,
  },
  {
    ...
    reviews: 74,
    sportTypes: ['Tennis'],
    image: '/images/featuredFacilities/japura-tennis.jpg',
    price: 'Rs. 2,500/hr',
    isNew: true,
    premium: false,
  },
  {
    ...
    image: '/images/featuredFacilities/kelaniya-badminton.jpg',
    price: 'Rs. 1,800/hr',
    isNew: false,
    premium: false,
  },
  {
    ...
    reviews: 89,
    sportTypes: ['Swimming'],
    image: '/images/featuredFacilities/kurunegala-swimming.jpg',
    price: 'Rs. 3,200/hr',
    isNew: true,
    premium: false,
  },
  {
    ...
    reviews: 156,
    sportTypes: ['Cricket'],
    image: '/images/featuredFacilities/galle-stadium.jpg',
    price: 'Rs. 7,500/hr',
    isNew: false,
    premium: true,
  },
  {
    ...
    reviews: 53,
    sportTypes: ['Tennis'],
    image: '/images/featuredFacilities/kandy-tennis.jpg',
    price: 'Rs. 2,200/hr',
    isNew: false,
    premium: false,
  },
  {
    ...
    image: '/images/featuredFacilities/negombo-volleyball.jpg',
    price: 'Rs. 1,500/hr',
    isNew: true,
    premium: false,
  },
