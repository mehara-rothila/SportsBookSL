    ...
    <div className="bg-gray-50 min-h-screen py-8">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow rounded-lg overflow-hidden">
          {/* User header */}
          <div className="bg-gradient-to-r from-primary-600 to-primary-800 px-6 py-16">
            <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center">
              <div className="rounded-full overflow-hidden h-32 w-32 border-4 border-white shadow-md mb-6 md:mb-0 md:mr-10">
                <img 
                  src={userData.avatar} 
                  alt={userData.name} 
          ...
          <div className="p-6">
            <Tab.Group>
              ...
              <Tab.Panels>
                            ...
                            <div className="flex flex-col md:flex-row">
                              ...
                              <div className="p-6 md:w-3/4 flex flex-col">
                                <div className="flex justify-between mb-2">
                                  <h4 className="text-xl font-semibold">{booking.facilityName}</h4>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                  <div>
                                    ...
                                    <p className="font-medium">{formatDate(booking.date)}, {booking.time}</p>
                                  </div>
                                  <div>
                                    <p className="text-sm text-gray-500">Sport Type</p>
                                    <p className="font-medium">{booking.sportType}</p>
                                  </div>
                                  <div>
                                  ...
                                  <div>
                                    ...
                                    <p className="font-medium">{formatCurrency(booking.cost)}</p>
                                  </div>
                                </div>
                                ...
                                <div className="flex items-center justify-between">
                                  <div className="flex items-center">
                                    ...
                                    <div className="ml-4">
                                      ...
                                      <p className="text-sm text-gray-500">{formatDate(booking.date)}, {booking.time}</p>
                                    </div>
                                  </div>
                                  <div className="flex items-center">
                                    ...
                                    <button className="ml-6 text-sm text-primary-600 hover:text-primary-900">View details</button>
                                  </div>
                                </div>
                              </div>
                            </div>
                ...
                <Tab.Panel>
                  <div className="mb-6">
                    <h2 className="text-2xl font-bold text-gray-900">Favorite Facilities</h2>
                    <p className="text-gray-600 mt-1">Quickly access your favorite sports facilities</p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {favoriteFacilities.map((facility) => (
                      <Link
                        ...
                        className="rounded-lg bg-white shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-200"
                      >
                    ...
                    <div className="rounded-lg border-2 border-dashed border-gray-300 p-6 flex flex-col items-center justify-center text-center h-80">
                      ...
                      <h3 className="text-gray-900 font-medium mb-1">Add more favorites</h3>
                      <p className="text-gray-500 text-sm mb-4">Browse facilities and save your favorites for quick access</p>
                      <Link
                        href="/facilities"
                ...
                <Tab.Panel>
                  <div className="mb-6 flex justify-between items-center">
                    <div>
                      <h2 className="text-2xl font-bold text-gray-900">Financial Aid Applications</h2>
                      <p className="text-gray-600 mt-1">Track and manage your financial assistance requests</p>
                    </div>
                    <Link
                  ...
                  {financialAidData.length > 0 ? (
                          ...
                          <li key={application.id} className="px-6 py-5">
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <p className="text-sm text-gray-500">Submitted on {formatDate(application.date)}</p>
                              </div>
                            ...
                            <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                              ...
                              {application.status === 'approved' && (
                                <div>
                                  ...
                                  <p className="text-xs text-gray-500">Valid until {formatDate(application.validUntil || '')}</p>
                                </div>
                              )}
                            </div>
                            ...
                            {application.status === 'approved' && (
                              <div className="mt-4 flex justify-end">
                                <button className="inline-flex items-center px-3 py-1.5 bg-primary-600 text-white text-sm font-medium rounded-md hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                                  Book Using Aid
                                </button>
                              </div>
                            )}
                    ...
                    <div className="text-center py-12 bg-gray-50 rounded-lg">
                      ...
                      <p className="text-gray-600 mb-3">You haven't submitted any financial aid applications yet.</p>
                      <Link
                        href="/financial-aid/apply"
