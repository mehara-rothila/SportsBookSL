  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (typeof window !== "undefined") {
        // Basic check if still in browser context
        setIsLoading(false);
      }
    }
  };
        ...
        <div className="space-y-6 relative">
          ...
          <div className="w-16 h-16 mx-auto rounded-full flex items-center justify-center mb-6 relative">
            ...
            <svg
              ...
              className="h-8 w-8 text-white relative z-10 drop-shadow-md"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
              ...
              <div className="flex">
                <div className="flex-shrink-0">
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M10 18a8 8 0 100-16 8 8 0 000 16zm-.707-4.293a1 1 0 001.414 0L12 12.414l1.293 1.293a1 1 0 101.414-1.414L13.414 11l1.293-1.293a1 1 0 10-1.414-1.414L12 9.586l-1.293-1.293a1 1 0 00-1.414 1.414L10.586 11l-1.293 1.293a1 1 0 000 1.414z"
                      clipRule="evenodd"
                    />
                  </svg>
                </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link
                  ...
                  className="font-medium text-emerald-300 hover:text-emerald-200 transition-colors duration-150 ease-in-out relative group"
                >
                  Forgot password?
            ...
            <div>
              <button
                type="submit"
                className={`w-full flex justify-center py-3.5 px-4 border border-transparent rounded-xl shadow-lg text-sm font-medium text-white bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-700 hover:to-emerald-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-all duration-150 ease-in-out relative overflow-hidden ${
          ...
          <div className="mt-8 text-center">
            ...
            <Link
              href="/register"
              className="inline-flex items-center justify-center px-6 py-2.5 border border-emerald-300/20 text-sm font-medium rounded-xl text-emerald-100 bg-emerald-700/30 hover:bg-emerald-700/50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-all duration-200 ease-in-out group"
            >
