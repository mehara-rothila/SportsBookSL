...
export default function ResetPasswordPage({ params }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(
        err.message ||
          "An unexpected error occurred. The OTP/token might be invalid or expired."
      );
      toast.error(
        err.message ||
          "Failed to reset password. OTP/token might be invalid or expired."
      );
    } finally {
      setIsLoading(false);
    }
      ...
      >
        ...
        <div className="space-y-6 relative">
          ...
          <div className="mt-8 text-center">
            <Link
              href="/login"
              className="font-medium text-emerald-300 hover:text-emerald-200 transition-colors relative inline-block group"
            >
              Back to Sign in
